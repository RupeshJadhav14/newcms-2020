        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    ...
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>">View Order</div>
                    </div>
                    <div class="topRight btnRight">
                        <ul class="btnUl">    
                            <li><a <?php if(isset($_GET['loc'])) { ?> href="index.php?m=mod_admin&a=dashboard" <?php } ?> href="index.php?m=mod_order&a=order_list" class="trans comBtn backBtn" title="Back to list">Back to list</a></li>
                        </ul>
                    </div>
                </div>
            </div>
