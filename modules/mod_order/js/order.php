	...
	var displayContacts = function(data,startIndex){ 
        ...
        for(i=0;i<data.records.length;i++)
        {
               ...
               // list = list + '<td><div class="pageName alignLeft">';
                ...
                list = list + '<td class="customerName alignLeft" data-title="Name:">' + data.records[i].product_name + '</td>';
                list = list + '<td class="customerName alignLeft" data-title="Email :">' + data.records[i].user_email + '</td>';

                list = list + '<td class="customerName alignLeft" data-title="Image :"><img src="http://localhost/newcms-2020/media/slider/'+data.records[i].img+'" style="height:100px;width: 150px;"></td>';

                list = list + '<td class="customerName alignLeft" data-title="Quantity:">' + data.records[i].qty + '</td>';

                list = list + '<td class="customerName alignLeft" data-title="Price:">' + data.records[i].price + '</td>';
               ...
               list = list + '<td class="customerName" align="center"><button style="padding: 7px;background: white;  border: groove;"> <a href="index.php?m=mod_order&a=order_edit&id=' + data.records[i].id + '"  title="' + data.records[i].name + '">Edit</a></button> &nbsp;<button style="padding: 7px;background: white;  border: groove;"> <a href="index.php?m=mod_order&a=order_delete&id=' + data.records[i].id + '"  title="' + data.records[i].name + '"> Delete </a></button> </td>';
                list = list + '</tr>';
