                                            ...
                                            <ul class="row">
                                                <div class="Personal-Info">
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="txtBox">
                                                            <input type="tel"  maxlength="10" class="txt numericOnly numbers" id="txtFax" name="fax" data-title="Fax" title="Fax">
                                                        </div>
                                                    </li>
                                                </div>
                                                ...
                                                <div class="Address-Info">
                                                   <li class="fullLi DefaultAdd"> <span>Address Information</span></li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="txtBox">
                                                            <select name="state" id="txtState" title="State">
                                                                <option value="">Select state</option>
                                                                <?php foreach (CFG::$stateArray as $key => $state) { ?>
