...
<!--  <li class="dropdown"> <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown"> <img src="../templates/admin/images/feed.png" alt="" class="image" style="width:32px; height:32px;" /> <span class="txt">Feeds</span> <b class="caret"></b> </a>
    ...
    <?php } ?>
    <?php if($data['config'][0]['active_action'] == '1' && $data['config'][0]['active_module'] == '1' ) { ?>
    <li class="configLi"><a href="index.php?m=mod_config&a=site_config" title="Site Configuration" class="config">Site Configuration</a></li>
    <?php } ?>
</ul>
<ul class="userUl">
    <li>
        ...
        <ul class="trans subUl">
            ...
            <li><a href="<?php echo URI::getURL('mod_user','user_logout'); ?>" class="logout" title="Logout">Logout</a></li>
