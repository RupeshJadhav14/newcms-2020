        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span>Banner List</span></div>
<!--                       <a class="trans addNew" title="New Page" data-title="New Banner" href="index.php?m=mod_banner&a=banner_edit" class="trans addNew" title="New Page">
                        Add New</a> -->
                    </div>
                    <div class="topRight">
                        <form id="searchForm" >
                            <div class="dropbox bulkDrop" style="display:none">
                                <select title="Please select actions">
                                    <option value="">Actions</option>
                                    <option value="" onclick="changeStatus('index.php?m=mod_banner&a=change_status', '', '1')">Active</option>
                                    <option value="" onclick="changeStatus('index.php?m=mod_banner&a=change_status', '', '0')">Inactive</option>
                                    <option value="" onclick="deleteRecord('index.php?m=mod_banner&a=delete_banner', '')">Delete</option>
                                </select>                        	
                            </div>

                            <div class="searchBox">
                                <input type="text" id="banner_name" name="searchForm[banner_name]" class="txt" title="Search banner" placeholder="Search Banner" />
...
<!--                        <ul class="table">
                            <li class="topLi">
                                ...
                                <div id="slug" class="sorting sort"><span>Page slug</span></div>
...
<table class="custom-table" width="100%">
                          ...
                          <!--      <th class="chekMain"> <div class="chkInn">
                                ...
                                <th id="slug" class="sorting sort "><span>Page slug</span></th>
    ...
    <div class="mobiAction" style="display:none;">
        ...
        <a href="#" onclick="changeStatus('index.php?m=mod_banner&a=change_status', '', '1')" title="Active" class="activeStatus"></a>
        <a href="#" onclick="changeStatus('index.php?m=mod_banner&a=change_status', '', '0')" title="Inactive" class="inactiveStatus"></a>
        <a href="#" onclick="deleteRecord('index.php?m=mod_banner&a=delete_banner', '')" title="Delete" class="delIcon">Delete</a>
