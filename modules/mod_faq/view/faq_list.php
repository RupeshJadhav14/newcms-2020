...
<section>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span>FAQ List</span></div>
                        <a href="index.php?m=mod_faq&a=faq_edit" class="trans addNew" title="New FAQ">New FAQ</a>
                    </div>
                    <div class="topRight">
                        <form id="searchForm" >
                            <div class="dropbox bulkDrop">
                                <select title="Please select actions">
                                    ...
                                    <option value="" onclick="changeStatus('index.php?m=mod_faq&a=change_status', '', '1')">Active</option>
                                    <option value="" onclick="changeStatus('index.php?m=mod_faq&a=change_status', '', '0')">Inactive</option>
                                    <option value="" onclick="deleteRecord('index.php?m=mod_faq&a=delete_faq', '')">Delete</option>
                                </select>                        	
                            </div>

                            <div class="searchBox">
                                <input type="text" id="faq" name="searchForm[question]" class="txt" title="Search FAQ" placeholder="Search FAQ" />
    ...
    <div class="mobiAction" style="display:none;">
        ...
        <a href="#" onclick="changeStatus('index.php?m=mod_faq&a=change_status', '', '1')" title="Active" class="activeStatus"></a>
        <a href="#" onclick="changeStatus('index.php?m=mod_faq&a=change_status', '', '0')" title="Inactive" class="inactiveStatus"></a>
        <a href="#" onclick="deleteRecord('index.php?m=mod_faq&a=delete_faq', '')" title="Delete" class="delIcon">Delete</a>
