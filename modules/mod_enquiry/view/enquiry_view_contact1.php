<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="box">
      <div class="title">
        <h4> <span class="icon16 icomoon-icon-equalizer-2"></span> <span>Enquiry details</span> </h4>
      </div>
     <div>
          ...
          <div>
                <ul class="shortcuts scroll" id="menu" >
                    <li class="topBtns"><a href="index.php?m=mod_enquiry&a=contact_enquiry_list" class="btn btn-warning applyTooptip" data-title="Back to enquiry list" id="btnSave" >Back to list</a></li>
               </ul>
          </div>
