...
<div class="row">
  <div class="col-md-12 col-sm-12">
    <div class="box">
      <div class="title">
        <h4> <span class="icon16 icomoon-icon-equalizer-2"></span> <span>Contact Enquiry List</span>
      ...
      <div class="search-bar">
        <form id="searchForm">
          <div class="input-append">
          	...
          	<label class="search-label">Search Contact Enquiry</label>
            <input class="low-line-height applyTooptip" id="contact" type="text" name="searchForm[contact]" data-content="Enter name, email or phone no to search" data-placement="top" rel="popover" data-title="Search Contact Enquiry" data-trigger="focus">
        ...
        <table class="responsive table table-bordered" id="checkAll" width="100%">
          <thead>
            <tr>
              ...
              <th style="width:15%" id="first_name" class="sort">Name</th>
              <th id="email" class="sort">Email</th>
              <th id="phone">Mobile</th>
              <th id="enquiry_date" class="sort">Enquiry Date</th>
