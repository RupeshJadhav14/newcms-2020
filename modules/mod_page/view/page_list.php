        ...
        <div class="container-fluid">
            <div class="row">
                <div class="fullColumn">
                    <div class="topLeft">
                        <div class="pageTitle blc-<?php echo APP::$moduleRecord['icon_class']; ?>"><span>Page List</span></div>
                        <!--<a href="index.php?m=mod_page&a=page_edit" class="trans addNew" title="New page">New page</a>-->
                    </div>
                    <div class="topRight">
                        <form id="searchForm" >
                            <div class="searchBox">
                                <input type="text" id="page_name" name="searchForm[page_name]" class="txt" title="Search page" placeholder="Search page" />
...
<!--                            <div class="dropbox bulkDrop">
                                <select title="Please select actions">
                                    ...
                                    <option value="" onclick="deleteRecord('index.php?m=mod_page&a=delete_page', '')">Delete</option>
                                </select>                         	
                            </div>-->
