...
//                list = list + '<td class="chekMain" align="center"><div class="chkInn"><label><input type="checkbox" id="status' + data.records[i].id + '" name="status[' + data.records[i].id + ']" value="' + data.records[i].status + '" class="checkbox" /><span></span></label></div></td>';
                ...
                list = list + '<td class="pageName"><a href="index.php?m=mod_page&a=page_edit&id=' + data.records[i].id + '"  title="' + data.records[i].name + '">' + data.records[i].name + '</a><ul class="optUl"><li><a href="index.php?m=mod_page&a=page_edit&id=' + data.records[i].id + '" title="Edit">Edit</a></li>';
//                list = list + '<li><a href="#" onclick="return changeStatus(\'index.php?m=mod_page&a=change_status\',' + data.records[i].id + ',\'\')" title="Change Status">Change Status</a></li><li class="delLi"><a href="#" onclick="deleteRecord(\'index.php?m=mod_page&a=delete_page\',' + data.records[i].id + ')" title="Delete">Delete</a></li>';
                ...
                list = list + '<td class="" data-title="Sort Order:" align="center"><input class="text-center sortTxt" type="text" maxlength="3" id="sort_order' + data.records[i].sort_order + '" name="sort_order[' + data.records[i].id + ']" value="' + data.records[i].sort_order + '" onblur="if(this.value!=' + data.records[i].sort_order + '){changeSortOrder(\'index.php?m=mod_page&a=save_sortorder\',this.value,' + data.records[i].id + ');}if(this.value.length == 0){this.value=len;}" onkeypress=\'return isNumberic(event);\' /></td>';
