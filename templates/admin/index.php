        ...
        <div class="wrapper">
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="fullColumn">
                                    <div class="headLeft">
                                        <a class="headLogo" href="index.php?m=mod_admin&a=dashboard" title="<?php echo CFG::$siteConfig['site_name']; ?>"><?php echo CFG::$siteConfig['site_name']; ?></a> 
                                    </div>
                                    <div class="headRight">
                            ...
                            <div class="row">
                                <div class="fullColumn">
                                    <div class="logo">
                                        ...
                                        <a href="index.php?m=mod_admin&a=dashboard" title="<?php echo CFG::$siteConfig['site_name']; ?>"><img src="<?php echo URI::getLiveTemplatePath(); ?>/images/logo.png" alt="<?php echo CFG::$siteConfig['site_name']; ?>" title="<?php echo CFG::$siteConfig['site_name']; ?>"></a>
                                    </div>
            ...
            <footer>
                ...
                <div class="footerMain">
                    <p>CMS Powered by:<a class="webential" href="http://www.webential.com.au/" title="Webential" target="_blank"></a></p>
                </div><!-- End .row-fluid -->
            </footer>
