...
_.returnFile = function(file) {
    ...
    if (_.opener.name == "ckeditor") {
        ...
        // author:parth parikh date:07-07-2016 for on select image in kcfinder tinymce.field value comes undefined stat 
        if(_.opener.TinyMCE.field == 'undefined'){
            $(win.document).find('#html-editor-hidden').val(file.find('.name').text());
            $(win.document).find('#html-editor-hidden').trigger('change');
            // author:parth parikh date:07-07-2016 for on select image in kcfinder tinymce.field value comes undefined end
        } else {
