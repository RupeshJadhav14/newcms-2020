...
--
-- Table structure for table `dtm_field`
--

DROP TABLE IF EXISTS `dtm_field`;
CREATE TABLE IF NOT EXISTS `dtm_field` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dtm_field`
--

INSERT INTO `dtm_field` (`id`, `field_name`, `sort_order`, `status`, `created_date`, `updated_date`) VALUES
(5, 'faq1', 1, '1', '2016-08-23 14:54:58', '2016-08-23 14:55:57'),
(6, 'faq2', 2, '1', '2016-08-23 14:55:23', '0000-00-00 00:00:00'),
(7, 'faq3', 3, '1', '2016-08-23 14:55:39', '2016-11-23 16:52:11');

-- --------------------------------------------------------

--
-- Table structure for table `dtm_field_section`
--

DROP TABLE IF EXISTS `dtm_field_section`;
CREATE TABLE IF NOT EXISTS `dtm_field_section` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dtm_field_section`
--

INSERT INTO `dtm_field_section` (`id`, `section_name`, `field_id`, `sort_order`, `status`, `created_date`, `updated_date`) VALUES
(5, 'faq1', 'faq1', 1, '1', '2016-08-23 14:54:58', '2016-08-23 14:55:57'),
(6, 'faq2', 'faq2', 2, '1', '2016-08-23 14:55:23', '0000-00-00 00:00:00'),
(7, 'faq3', 'faq3', 3, '1', '2016-08-23 14:55:39', '2016-11-23 16:52:11');
...
--
-- Table structure for table `dtm_field_section_machine`
--

DROP TABLE IF EXISTS `dtm_field_section_machine`;
CREATE TABLE IF NOT EXISTS `dtm_field_section_machine` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `dtm_field_section_machine`
--

INSERT INTO `dtm_field_section_machine` (`id`, `machine_name`, `section_id`, `sort_order`, `status`, `created_date`, `updated_date`) VALUES
(5, 'faq1', 'faq1', 1, '1', '2016-08-23 14:54:58', '2016-08-23 14:55:57'),
(6, 'faq2', 'faq2', 2, '1', '2016-08-23 14:55:23', '0000-00-00 00:00:00'),
(7, 'faq3', 'faq3', 3, '1', '2016-08-23 14:55:39', '2016-11-23 16:52:11');
...
--
-- Table structure for table `dtm_field_value`
--

DROP TABLE IF EXISTS `dtm_field_value`;
CREATE TABLE IF NOT EXISTS `dtm_field_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `question` varchar(255) NOT NULL,
  `answer` text NOT NULL,
  `sort_order` int(11) NOT NULL,
...
--
-- Dumping data for table `dtm_field_value`
--

INSERT INTO `dtm_field_value` (`id`, `question`, `answer`, `sort_order`, `status`, `created_date`, `updated_date`) VALUES
(5, 'faq1', 'faq1', 1, '1', '2016-08-23 14:54:58', '2016-08-23 14:55:57'),
(6, 'faq2', 'faq2', 2, '1', '2016-08-23 14:55:23', '0000-00-00 00:00:00'),
(7, 'faq3', 'faq3', 3, '1', '2016-08-23 14:55:39', '2016-11-23 16:52:11');
...
(89, 'Field Edit', 'mod_field', 'field_edit', 0, NULL, 'admin', 'private', NULL, NULL, 0, '', '', '', '', '', '2016-08-22 00:00:00', '1', '1', '1'),
(90, 'Field Manager', 'mod_field', 'field_list', 0, NULL, 'admin', 'private', '1', 'Field Manager', 4, '', '', '', '', '', '2016-08-22 00:00:00', '1', '1', '1'),
(91, 'Field Change Status', 'mod_field', 'change_status', 0, NULL, 'admin', 'private', NULL, NULL, 0, '', '', '', '', '', '2016-08-22 00:00:00', '1', '1', '1'),
(92, 'Field Delete', 'mod_field', 'delete_field', 0, NULL, 'admin', 'private', NULL, NULL, 0, '', '', '', '', '', '2016-08-22 00:00:00', '1', '1', '1'),
(93, 'Field Save Sort Order', 'mod_field', 'save_sortorder', 0, NULL, 'admin', 'private', NULL, NULL, 0, '', '', '', '', '', '2016-08-23 00:00:00', '1', '1', '1');
...
(14, 'Test3', '', '', '', '', '', '', '', '1', 3, '2016-08-22 15:03:07', '2016-11-23 17:45:27', 1, '0'),
(15, 'test', '', '', '', '', '', '', '', '1', 15, '2017-02-17 15:36:05', '2017-02-17 15:36:05', 1, '0');
...
(24, 'Test User', 'test.datatech', '6CD5zKeIjvdpJeCoF8FMNA==', 'test.datatechmedia4r@gmail.com', 'sydney', 'NSW', 0, 'new Address', '4848', '9999999999', '9999999999', '', 5, '1', '0', '0000-00-00 00:00:00', '2017-05-11 20:58:00', '2020-07-07 11:22:52', 1, 1),
